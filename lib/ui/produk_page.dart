...
class _ProdukPageState extends State<ProdukPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Inventaris Komputer ZaimMart"),
        actions: [
          Padding(
      ...
      drawer: Drawer(
        child: ListView(
          children: [
            ListTile(
              title: const Text('Logout ZaimMart'),
